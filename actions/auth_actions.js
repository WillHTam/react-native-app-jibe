...
// By default, the entire store is flushed when the app is exited,
    // so we should save the token in the AsyncStorage so that the app remembers the token and thus if the user is logged in 
...
// How to use AsyncStorage: Async uses promises, not instant
